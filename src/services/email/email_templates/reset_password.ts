const resetPass = (url: string) => `<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8" />
        ...
        <![endif]-->
          ...
          >
            <tr>
              ...
              <img
              src="https://i0.wp.com/canza.io/wp-content/uploads/2021/10/Canza-Finance-1.png?w=608&ssl=1"
              alt=""
              width="50%"
            />
              </td>
            ...
            <tr>
              ...
              >
                <p style="margin: 0">
                  ...
                  request a password reset, you can safely delete this email.
                </p>
                <p style="margin: 0">
                  Note that this link will expire in 5 minutes
                </p>
              </td>
            </tr>
            <!-- end copy -->
